...
#FIXME: Check 269 and 235.

#FIXME: Error updating interaction history: 'coroutine' object has no attribute 'state'
#
#---------- State AFTER processing ----------
#Error displaying state: 'coroutine' object has no attribute 'state'